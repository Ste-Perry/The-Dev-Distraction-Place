    ...
    return (
        ...
        <button className="meditation-button" onClick={onClick}>Sounds</button>
            {showElements ? <div className="audio-list">
                <div className="audio-name">Rain and Thunderstorm Sounds For Focus, Relaxing and Sleep</div>
                <audio controls>
                    <source src="/nature-sounds/1.m4a" type="audio/ogg" />
                        Your browser does not support the audio element.
                </audio>

                <div className="audio-name">Calm Seashore</div>
                <audio controls>
                    <source src="/nature-sounds/2.m4a" type="audio/ogg" />
                        Your browser does not support the audio element.
                </audio>

                <div className="audio-name">Nature Forest Birds</div>
                <audio controls>
